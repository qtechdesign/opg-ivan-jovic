/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5b686410b7de10caeea80e40ccdb8968)
// Runtime types generated with workerd@1.20250906.0 2026-08-31 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SERVICE_NAME: "polje";
		DEFAULT_FARM_SLUG: "ivan-jovic";
		INGEST_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVICE_NAME" | "DEFAULT_FARM_SLUG" | "INGEST_TOKEN" | "OPERATOR_TOKEN" | "OPERATOR_EMAIL" | "OPERATOR_PASSWORD">> {}
}
