...
DELETE FROM readings WHERE device_id IN ('soil-n-1', 'temp-yard-1', 'edge-1', 'cam-yard', 'cam-garden', 'cam-hay');
...
-- M2 stub sensors + M3 camera slots (address = env key label, not a URL)
